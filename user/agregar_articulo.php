...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")){
	...
	$autor=$_POST['autor'];
	$insertSQL= sprintf("INSERT INTO articulos(titulo, seo, keywords, descripcion, mensajes, categoria, autor, fecha) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
	...
	$relacion= sprintf("INSERT INTO articulos_users(id_user) VALUES (%s)",
		GetSQLValueString($autor, "int"));
	$Result2= mysql_query($relacion) or die (mysql_error());
