			...
			<div id="izquierda">
				...
				<div id="contenido">
					<article>
						...
						$query_DatosListado = "SELECT * FROM articulos WHERE titulo LIKE '%$busqueda%'"; 
						...
						?>
						<?php if  ($totalRows_DatosListado == 0){?>
							<section id="section_l">No se han encontrado resultados</section>
							<?php } else if(empty($busqueda)){ ?>
							<section id="section_l">Por favor, introduzca lo que desea buscar</section>
							<?php }else {?>
							<section id="section_l">Resultados encontrados <?php echo $totalRows_DatosListado;?>
														<?php do { ?>
							<table width="100%" border="0" style="border-top:1px dashed #ccc">
							<tr>
											<td width="294" align="left" style="padding:10px"><a href="ver_articulo.php?date=<?php echo $row_DatosListado['id'];?>"><?php echo $row_DatosListado['titulo'];?></a></td>
